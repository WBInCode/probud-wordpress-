		...
		<div class="contact-grid">
			<div class="fade-up">
				<div class="section-header">
					...
					<h2 class="section-title" style="font-size:clamp(1.75rem, 3vw, 2.5rem);">Skontaktuj się z&nbsp;nami</h2>
					<p class="section-desc">Masz pytania lub chcesz omówić projekt? Jesteśmy do Twojej dyspozycji.</p>
				</div>
				<ul class="contact-info-list">
					<?php foreach ( $contacts as $c ) : ?>
					<li class="contact-info-item">
						<div class="contact-info-icon"><?php echo $c['icon']; ?></div>
						<div>
							<div class="contact-info-label"><?php echo esc_html( $c['label'] ); ?></div>
							<div class="contact-info-value"><?php echo esc_html( $c['value'] ); ?></div>
						</div>
					</li>
					<?php endforeach; ?>
				</ul>
